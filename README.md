...
* If not, fetch latitude and longitude using external Geocoding API (only once per pincode, then cached)
* Fetch weather data using coordinates
* Save response in database and return result

## APIs
* `GET /api/weather?pincode={pincode}&forDate={forDate}` – Get weather details
